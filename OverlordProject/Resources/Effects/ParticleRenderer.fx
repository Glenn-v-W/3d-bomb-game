...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
	...
	topLeft = float3( -size * 0.5, size * 0.5, 0.f);
	topRight = float3(size * 0.5, size * 0.5, 0.f);
	bottomLeft = float3(-size * 0.5,  -size * 0.5, 0.f);
	bottomRight = float3(size * 0.5,  -size * 0.5, 0.f);
